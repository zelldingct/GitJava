...
public class AccountDao {
	...
	Scanner sc = new Scanner(System.in);
		...
		public AccountDao() {
			list.add(new AccountDto("21/09/08", 17000, "지출", "저녁 식사", "친구와 치킨사먹음"));
			list.add(new AccountDto("21/09/08", 300000, "수입", "알바비", "8월달 근로소득"));
			list.add(new AccountDto("21/09/08", 1400, "지출", "간식", "편의점 콜라"));
		}
		//오늘의 날짜
