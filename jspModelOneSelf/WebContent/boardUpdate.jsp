...
<tr>
	<th>제목</th>
	<td><input type="text" value="<%=dto.getTitle().replaceAll("\"", "&#34;") %>" size="50" name="title"></td>
</tr>
...
if(dto.getId().equals( acc.getId() )){
	%>
	<button type="button" onclick="updatePost(<%=dto.getSeq() %>)">Done</button>	
<% 
}
%>
...
function updatePost(seq) {
	//alert(seq);
	location.href = "boardUpdateAf.jsp?seq=" + seq;
}
</script>
</body>
</html>